...
const renderDonutLayout = (langs, width, totalLanguageSize, statsFormat) => {
	// Fixed positioning for donut chart - use consistent sizing
	const donutSize = 170; // Fixed size for the donut chart area
	const centerX = donutSize / 2;
	const centerY = donutSize / 2;
	const radius = 56.67; // Consistent radius for the donut
	...
	// Calculate vertical offset based on number of languages
