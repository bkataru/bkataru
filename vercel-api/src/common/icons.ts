/**
 * SVG icon paths for GitHub stats.
 */
...
/**
 * Get rank icon SVG content based on type.
 *
 * @param rankIcon - The rank icon type ("github", "percentile", or "default").
 * @param rankLevel - The rank level text (e.g., "A+", "S").
 * @param percentile - The rank percentile.
 * @returns The SVG code of the rank icon.
 */
export function getRankIcon(
  rankIcon: string,
  rankLevel: string,
  percentile: number
): string {
